...
test_that("sim_setup works as expected", {
  ...
  expect_named(out, c("mana", "sb_dmg", "sb_miss", "sb_crit", "sb_manacost", "lt_manacost", "curse_miss"))
  expect_type(out, "list")
  expect_equivalent(lengths(out), c(1, 10, 10, 10, 1, 1, 10))
  expect_equivalent(lapply(out, typeof), c("double", "double", "logical", "logical", "double", "double", "logical"))
